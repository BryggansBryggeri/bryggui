  ...
  <div class="flex flex-col w-full rounded-lg px-4 py-5">
    <div class="flex flex-col rounded-lg bg-base-200 p-4 space-y-4">
      ...
      <div class="flex flex-row justify-between rounded-lg">
        ...
        <on-off-toggle :state="contrActive" :disabled="disabled" @click="toggleContr" />
      </div>
      ...
      <ModeToggle :mode="contrMode" :disabled="!contrActive" @toggleEvent="toggleMode" />
      <div class="flex flex-row justify-between align-center">
        <h3>Set target:</h3>
        <input v-model="parseTarget" type="text" :disabled="!contrActive" :placeholder="parseTarget"
